...
def generate_data_loaders_from_distributed_dataset(distributed_dataset,
    batch_size):
    """
    ...
    for worker_training_data in distributed_dataset:
        data_loaders.append(Dataset.get_data_loader_from_data(batch_size,
         worker_training_data[0], worker_training_data[1], shuffle=True))
...
def load_data_loader_from_file(logger, filename):
    ...
    """
    logger.info("Loading data loader from file: {}".
        format(filename))
