...
class Arguments:
    ...
    def get_learning_rate_from_epoch(self, epoch_idx):
        lr = self.lr * (self.scheduler_gamma **
         int(epoch_idx / self.scheduler_step_size))

        if lr < self.min_lr:
            self.logger.warning("Updating LR would place"
    ...
    def __str__(self):
        return "\nBatch Size: {}\n".format(self.batch_size) + \
               ...
               format(json.dumps(self.round_worker_selection_strategy_kwargs,
