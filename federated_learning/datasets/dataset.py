...
class Dataset:
	...
	def load_train_dataset(self):
		...
		("load_train_dataset() isn't implemented")
	...
	def load_test_dataset(self):
		...
		"""
		raise NotImplementedError
		("load_test_dataset() isn't implemented")
	...
	def get_train_loader(self, batch_size, **kwargs):
		...
		"""
		return Dataset.get_data_loader_from_data(batch_size,
		 self.train_dataset[0],
		 self.train_dataset[1], **kwargs)
	...
	def get_data_loader_from_data(batch_size, X, Y, **kwargs):
		...
		if "classification_problem" in kwargs and
		 kwargs["classification_problem"] == False:
	...
	def get_tuple_from_data_loader(data_loader):
		"""
		Get a tuple representation of the data stored in 
		a data loader.
